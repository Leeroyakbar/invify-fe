  ...
  return (
    <section className="relative bg-gradient-to-b from-[#FFF9F4] via-[#F6E6E3] to-white">
      <div className="max-w-7xl mx-auto px-6 py-28 text-center">
        <span className="inline-block px-4 py-2 rounded-full bg-[#F6E6E3] text-sm text-[#7A6F68]">✨ Platform Undangan Digital #1 Indonesia</span>
        ...
        <div className="mt-10 flex justify-center gap-4">
          <button className="px-8 py-4 rounded-full bg-[#D4A853] text-white shadow-lg">Lihat Template</button>
          <button className="px-8 py-4 rounded-full border border-[#D4A853] text-[#D4A853]">Buat Undangan</button>
        </div>
      </div>
    </section>
  )
